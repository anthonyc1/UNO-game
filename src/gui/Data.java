...
public class Data {
    ...
    public void setupCardbacks(){
        ...
        back2 = new Card(image, 75, 50);
        back3 = new Card(image, 75, 50);
        back4 = new Card(image, 75, 50);
        back5 = new Card(image, 75, 50);
        back6 = new Card(image, 75, 50);
        back7 = new Card(image, 75, 50);
        back8 = new Card(image, 75, 50);
        back9 = new Card(image, 75, 50);
        back10 = new Card(image, 75, 50);
        back11 = new Card(image, 75, 50);
        back12 = new Card(image, 75, 50);
        back13 = new Card(image, 75, 50);
        back14 = new Card(image, 75, 50);
        back15 = new Card(image, 75, 50);
        back16 = new Card(image, 75, 50);
        back17 = new Card(image, 75, 50);
        back18 = new Card(image, 75, 50);
        back19 = new Card(image, 75, 50);
        back20 = new Card(image, 75, 50);
        back21 = new Card(image, 75, 50);
        back22 = new Card(image, 75, 50);
        back23 = new Card(image, 75, 50);
        back24 = new Card(image, 75, 50);
        back25 = new Card(image, 75, 50);
        back26 = new Card(image, 75, 50);
        back27 = new Card(image, 75, 50);
        back28 = new Card(image, 75, 50);
        back29 = new Card(image, 75, 50);
        back30 = new Card(image, 75, 50);
        back31 = new Card(image, 75, 50);
